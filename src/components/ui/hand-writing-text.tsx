      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          <motion.path
            ...
            variants={draw}
            className="text-mauve-light/60"
          />
        </motion.svg>
      </div>
      <div className="relative text-center z-10 flex flex-col items-center justify-center">
        <motion.h2
          className="font-serif text-4xl md:text-6xl text-white tracking-tight flex items-center gap-2"
        ...
        {subtitle && (
          <motion.p
            className="text-lg text-white/60 font-sans font-light mt-2"
            initial={{ opacity: 0 }}

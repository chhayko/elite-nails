// Service page content for all locales — data only, no UI.
...
export type LocaleData = Record<string, ServiceEntry>;

export const serviceData: Record<string, LocaleData> = {
  en: {
    "russische-manicure": {
...
export const nlSeoMeta: Record<string, { title: string; description: string }> = {
  "russische-manicure": {
